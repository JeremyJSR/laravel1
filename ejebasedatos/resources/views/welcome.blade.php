...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <a href="listarA">Prueba de la libreria DB - consulta A</a><br>
        <a href="listarB">Prueba de la libreria DB - consulta B</a><br>
        <a href="listarC">Prueba de la libreria DB - consulta C Multitabla</a><br>
